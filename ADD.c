...
void add_reg_assm(void) {
    ...
    */
    ...
    // This is ADD register, so param 2 needs to be a register
    if (PARAM2.type != REGISTER) {
        state = MISSING_REG;
        return;
    }

    // This is ADD register, so param 3 needs to be a register
    ...
    */
    ...
    // Set the opcode
    setBits_num(31, 0, 6); // Opcode remains the same for R-type instructions
